\documentclass[11pt,
hyperref={colorlinks,citecolor=purple,linkcolor=red!30!black,urlcolor=blue}
    ]{beamer}
...
% font
%\usefonttheme{professionalfonts}  % Options: default, serif, professionalfonts,structurebold,
% structureitalicserif, structuresmallcapsserif
\usepackage[defaultfeatures={Ligatures=NoCommon}]{libertine}
...
\setCJKmainfont[BoldFont=SourceHanSerifSC-Bold]{SourceHanSerifSC-Regular}  % 思源宋体

\usepackage{booktabs}
\usepackage[scale=2]{ccicons}  % support for Creative Commons Icons
